...
public final class KvRepartitionController<I extends Comparable<I>, K extends Comparable<K>, S> implements EventloopJmxMBeanEx {
	private final I localPartitionId;
	private final CrdtClient<K, S> localClient;
	private final KvCluster<I, K, S> cluster;

	public KvRepartitionController(I localPartitionId, CrdtClient<K, S> localClient, KvCluster<I, K, S> cluster) {
		this.localClient = localClient;
		this.cluster = cluster;
		this.localPartitionId = localPartitionId;
	}

	public static <I extends Comparable<I>, K extends Comparable<K>, S> KvRepartitionController<I, K, S> create(KvCluster<I, K, S> cluster, I localPartitionId) {
		return new KvRepartitionController<>(localPartitionId, cluster.getClients().get(localPartitionId), cluster);
	}
