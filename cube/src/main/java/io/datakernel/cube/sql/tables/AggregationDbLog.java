...
public class AggregationDbLog extends TableImpl<AggregationDbLogRecord> {
	...
	private static final long serialVersionUID = -745127125;
	...
	/**
	 * The column <code>aggregation_db_log.revision_id</code>.
	 */
	public final TableField<AggregationDbLogRecord, Integer> REVISION_ID = createField("revision_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
	 ...
	 */
	@Override
	public UniqueKey<AggregationDbLogRecord> getPrimaryKey() {
		return Keys.KEY_AGGREGATION_DB_LOG_PRIMARY;
	}
	 ...
	 */
	@Override
	public List<UniqueKey<AggregationDbLogRecord>> getKeys() {
		return Arrays.<UniqueKey<AggregationDbLogRecord>>asList(Keys.KEY_AGGREGATION_DB_LOG_PRIMARY);
	}
