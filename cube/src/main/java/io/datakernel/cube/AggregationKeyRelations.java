...
public final class AggregationKeyRelations {
	...
	private AggregationKeyRelations() {
	}

	public static AggregationKeyRelations create() {
		return new AggregationKeyRelations();
	}

	public AggregationKeyRelations withRelations(Map<String, String> childParentRelationships) {
	...
	public AggregationKeyRelations withRelation(String child, String parent) {
