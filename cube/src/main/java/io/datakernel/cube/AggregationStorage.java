 ...
 */
public interface AggregationStorage {
	/**
	 ...
	 * @param dimensions    dimensions of chunk record
	 * @param measures      measures of chunk record
	 ...
	 */
	<T> StreamProducer<T> chunkReader(String aggregationId, List<String> dimensions, List<String> measures, Class<T> recordClass, long id);
	 ...
	 */
	<T> StreamConsumer<T> chunkWriter(String aggregationId, List<String> dimensions, List<String> measures, Class<T> recordClass, long id);
