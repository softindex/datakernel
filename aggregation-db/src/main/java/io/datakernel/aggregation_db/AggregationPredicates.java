...
public class AggregationPredicates {
	...
	public static final class PredicateAlwaysFalse implements AggregationPredicate {
		...
		@Override
		public PredicateDef createPredicateDef(Expression record, FieldConverters converters) {
	...
	public static final class PredicateNot implements AggregationPredicate {
		...
		@Override
		public PredicateDef createPredicateDef(Expression record, FieldConverters converters) {
			return Expressions.not(predicate.createPredicateDef(record, converters));
		}
	...
	public static final class PredicateEq implements AggregationPredicate {
		...
		@Override
		public PredicateDef createPredicateDef(Expression record, FieldConverters converters) {
			return cmpEq(field(record, key.replace('.', '$')), value(converters.toInternalValue(key, value)));
		}
	...
	public static final class PredicateBetween implements AggregationPredicate {
		...
		public PredicateDef createPredicateDef(Expression record, FieldConverters converters) {
			return Expressions.and(
					cmpGe(field(record, key.replace('.', '$')), value(converters.toInternalValue(key, from))),
					cmpLe(field(record, key.replace('.', '$')), value(converters.toInternalValue(key, to))));
		}
	...
	public static final class PredicateAnd implements AggregationPredicate {
		...
		public PredicateDef createPredicateDef(Expression record, FieldConverters converters) {
			...
			for (AggregationPredicate predicate : predicates) {
				predicateDefs.add(predicate.createPredicateDef(record, converters));
			}
	...
	public static RangeScan toRangeScan(AggregationPredicate predicate, List<String> primaryKey, FieldConverters converters) {
