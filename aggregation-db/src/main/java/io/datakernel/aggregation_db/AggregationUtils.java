...
public class AggregationUtils {
	...
	public static Class<?> createKeyClass(HasAggregationStructure structure, List<String> keys, DefiningClassLoader classLoader) {
		return createKeyClass(projectKeys(structure.getKeyTypes(), keys), classLoader);
	}
	...
	public static Class<?> createRecordClass(HasAggregationStructure structure,
	                                         List<String> keys, List<String> fields,
	                                         DefiningClassLoader classLoader) {
	...
	public static <T> BufferSerializer<T> createBufferSerializer(HasAggregationStructure structure, Class<T> recordClass,
	                                                             List<String> keys, List<String> fields,
	                                                             DefiningClassLoader classLoader) {
		return createBufferSerializer(recordClass, projectKeys(structure.getKeyTypes(), keys), projectFields(structure.getFieldTypes(), fields), classLoader);
	}
	...
	public static StreamReducers.Reducer aggregationReducer(HasAggregationStructure structure, Class<?> inputClass, Class<?> outputClass,
	                                                        List<String> keys, List<String> fields,
	                                                        DefiningClassLoader classLoader) {
		...
		for (String field : fields) {
			AggregateFunction aggregateFunction = structure.getFieldAggregateFunction(field);
	...
	public static Aggregate createPreaggregator(HasAggregationStructure structure, Class<?> inputClass, Class<?> outputClass,
	                                            List<String> keys, List<String> fields,
...
//		ExpressionSequence accumulateDef = sequence();
		...
		for (String outputField : fields) {
			...
			createAggregateExpressions(structure, accumulator, inputField, inputClass,
	...
	private static void createAggregateExpressions(HasAggregationStructure structure, Expression accumulator, String inputField, Class<?> inputClass,
		...
		AggregateFunction aggregateFunction = structure.getFieldAggregateFunction(outputField);
