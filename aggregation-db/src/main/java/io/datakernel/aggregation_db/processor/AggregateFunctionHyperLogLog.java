...
public final class AggregateFunctionHyperLogLog extends AggregateFunction {
	...
	AggregateFunctionHyperLogLog(int registers) {
		super(new FieldTypeHyperLogLog());
		this.registers = registers;
	}

	public static AggregateFunctionHyperLogLog create(int registers) {
