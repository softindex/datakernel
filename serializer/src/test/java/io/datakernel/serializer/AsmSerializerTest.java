...
public class AsmSerializerTest {
	...
	public void testProfiles() {
		BufferSerializer<TestDataProfiles> serializer = SerializerBuilder.newDefaultInstance(ClassLoader.getSystemClassLoader()).create(TestDataProfiles.class);
		BufferSerializer<TestDataProfiles> serializer1 = SerializerBuilder.newDefaultInstance("profile1", ClassLoader.getSystemClassLoader()).create(TestDataProfiles.class);
		BufferSerializer<TestDataProfiles> serializer2 = SerializerBuilder.newDefaultInstance("profile2", ClassLoader.getSystemClassLoader()).create(TestDataProfiles.class);
