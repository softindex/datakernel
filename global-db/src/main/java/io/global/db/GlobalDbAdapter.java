...
public final class GlobalDbAdapter implements DbClient {
	public static final StacklessException UPK_UPLOAD = new StacklessException(GlobalDbAdapter.class, "Trying to upload to public key without knowing it's private key");
	public static final StacklessException UPK_DELETE = new StacklessException(GlobalDbAdapter.class, "Trying to delete file at public key without knowing it's private key");
	...
	public GlobalDbAdapter(GlobalDbDriver driver, PubKey space, @Nullable PrivKey privKey) {
		this.driver = driver;
		this.space = space;
