...
public class CodeGenSerializerTest {
	...
	public void testVersions() {
		...
		BufferSerializer<TestDataVersions> serializer0 = SerializerCodeGenFactory.createBufferSerializerFactory().createBufferSerializer(serializerGen, 0);
		BufferSerializer<TestDataVersions> serializer1 = SerializerCodeGenFactory.createBufferSerializerFactory().createBufferSerializer(serializerGen, 1);
		BufferSerializer<TestDataVersions> serializer2 = SerializerCodeGenFactory.createBufferSerializerFactory().createBufferSerializer(serializerGen, 2);
	...
	public void testProfiles() {
		...
		BufferSerializer<TestDataProfiles> serializer = SerializerCodeGenFactory.createBufferSerializerFactory().createBufferSerializer(registry.serializer(type));
		BufferSerializer<TestDataProfiles> serializer1 = SerializerCodeGenFactory.createBufferSerializerFactory().createBufferSerializer(registry1.serializer(type));
		BufferSerializer<TestDataProfiles> serializer2 = SerializerCodeGenFactory.createBufferSerializerFactory().createBufferSerializer(registry2.serializer(type));
	...
	public void testProfilesVersions() {
		...
		BufferSerializer<TestDataProfiles2> serializer1 = SerializerCodeGenFactory.createBufferSerializerFactory().createBufferSerializer(registry.serializer(type),
				1);
		BufferSerializer<TestDataProfiles2> serializer2 = SerializerCodeGenFactory.createBufferSerializerFactory().createBufferSerializer(registry.serializer(type),
				2);
		BufferSerializer<TestDataProfiles2> serializer1Profile = SerializerCodeGenFactory.createBufferSerializerFactory().createBufferSerializer(
				registryProfile.serializer(type), 1);
		BufferSerializer<TestDataProfiles2> serializer2Profile = SerializerCodeGenFactory.createBufferSerializerFactory().createBufferSerializer(
