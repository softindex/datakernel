...
public class ExpressionSetForEach implements Expression {
	private final Expression field;
	private final ForVar forKey;

	ExpressionSetForEach(Expression field, ForVar forKey) {
		this.field = field;
		this.forKey = forKey;
	}
	...
	public boolean equals(Object o) {
		...
		ExpressionSetForEach that = (ExpressionSetForEach) o;
