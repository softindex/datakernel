...
public final class FunctionDefHash implements FunctionDef {
	private final List<FunctionDef> arguments;

	FunctionDefHash(List<FunctionDef> arguments) {
	...
	public Type load(Context ctx) {
		...
		for (FunctionDef argument : this.arguments) {
			if (firstIteration) {
				g.push(0);
	...
	public boolean equals(Object o) {
		...
		FunctionDefHash that = (FunctionDefHash) o;
