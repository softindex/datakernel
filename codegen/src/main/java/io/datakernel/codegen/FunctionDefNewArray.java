...
public class FunctionDefNewArray implements FunctionDef {
	private final Class<?> type;
	private final FunctionDef length;

	FunctionDefNewArray(Class<?> type, FunctionDef length) {
		this.type = type;
		this.length = length;
	}
	...
	public boolean equals(Object o) {
		...
		FunctionDefNewArray that = (FunctionDefNewArray) o;
