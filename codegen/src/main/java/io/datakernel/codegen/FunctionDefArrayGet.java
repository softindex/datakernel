...
public class FunctionDefArrayGet implements FunctionDef {
	private final FunctionDef array;
	private final FunctionDef nom;

	FunctionDefArrayGet(FunctionDef array, FunctionDef nom) {
		this.array = array;
		this.nom = nom;
	}
	...
	public boolean equals(Object o) {
		...
		FunctionDefArrayGet that = (FunctionDefArrayGet) o;
