 ...
 */
public final class FunctionDefComparator implements FunctionDef {
	private final List<FunctionDef> left = new ArrayList<>();
	private final List<FunctionDef> right = new ArrayList<>();

	FunctionDefComparator() {
	}
	...
	public FunctionDefComparator add(FunctionDef left, FunctionDef right) {
		this.left.add(left);
	...
	public boolean equals(Object o) {
		...
		FunctionDefComparator that = (FunctionDefComparator) o;
