...
public class FunctionDefArraySet implements FunctionDef {
	private final FunctionDef array;
	private final FunctionDef position;
	private final FunctionDef newElement;

	FunctionDefArraySet(FunctionDef array, FunctionDef position, FunctionDef newElement) {
		this.array = array;
	...
	public boolean equals(Object o) {
		...
		FunctionDefArraySet that = (FunctionDefArraySet) o;
