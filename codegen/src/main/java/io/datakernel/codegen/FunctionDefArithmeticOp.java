 ...
 */
public final class FunctionDefArithmeticOp implements FunctionDef {
	FunctionDefArithmeticOp(Operation op, FunctionDef left, FunctionDef right) {
		this.op = op;
		this.left = left;
		this.right = right;
	}
	...
	private final FunctionDef left;
	private final FunctionDef right;
	...
	public Type load(Context ctx) {
		...
		FunctionDef leftVar = left;
		FunctionDef rightVar = right;
	...
	public boolean equals(Object o) {
		...
		FunctionDefArithmeticOp that = (FunctionDefArithmeticOp) o;
