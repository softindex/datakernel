...
public class FunctionDefCallForDynamicType implements FunctionDef {
	private final Type owner;
	private final String methodName;
	private final Type returnType;
	private final List<FunctionDef> arguments = new ArrayList<>();

	FunctionDefCallForDynamicType(String owner, String methodName, Type returnType, FunctionDef... arguments) {
		this.owner = getType("L" + owner.replace(".", "/") + ";");
	...
	public Type load(Context ctx) {
		...
		g.newInstance(owner);
		g.dup();
		g.invokeConstructor(owner, Method.getMethod("void <init> ()"));
	...
	public boolean equals(Object o) {
		...
		FunctionDefCallForDynamicType that = (FunctionDefCallForDynamicType) o;
