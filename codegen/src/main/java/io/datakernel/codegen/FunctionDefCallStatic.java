...
public class FunctionDefCallStatic implements FunctionDef {
	private final Class<?> owner;
	private final String name;
	private final List<FunctionDef> arguments = new ArrayList<>();

	FunctionDefCallStatic(Class<?> owner, String name, FunctionDef... arguments) {
		this.owner = owner;
		this.name = name;
	...
	public boolean equals(Object o) {
		...
		FunctionDefCallStatic that = (FunctionDefCallStatic) o;
