...
public final class FunctionDefToString implements FunctionDef {
	private String begin = "{";
	private String end = "}";
	private String separator = " ";
	private final Map<Object, FunctionDef> arguments = new LinkedHashMap<>();

	FunctionDefToString(Map<String, FunctionDef> arguments) {
	...
	public FunctionDefToString add(String label, FunctionDef functionDef) {
		this.arguments.put(label, functionDef);
		return this;
	}

	public FunctionDefToString add(FunctionDef functionDef) {
		this.arguments.put(arguments.size() + 1, functionDef);
		return this;
	}

	public FunctionDefToString separator(String separator) {
		this.separator = separator;
		return this;
	}

	public FunctionDefToString quotes(String begin, String end) {
		this.begin = begin;
		this.end = end;
		return this;
	}

	public FunctionDefToString quotes(String begin, String end, String separator) {
		this.begin = begin;
		this.end = end;
		this.separator = separator;
		return this;
	...
	public Type load(Context ctx) {
		...
		for (Object key : arguments.keySet()) {
			...
			g.dup();
			FunctionDef functionDef = arguments.get(key);
	...
	public boolean equals(Object o) {
		...
		FunctionDefToString that = (FunctionDefToString) o;
