...
public class FunctionDefMapForEach implements FunctionDef {
	private final FunctionDef field;
	private final ForVar forKey;
	private final ForVar forValue;

	FunctionDefMapForEach(FunctionDef field, ForVar forKey, ForVar forValue) {
		this.field = field;
		this.forKey = forKey;
	...
	public boolean equals(Object o) {
		...
		FunctionDefMapForEach that = (FunctionDefMapForEach) o;
