...
public class GlobalPixelApp extends Launcher {
	public static final String PROPERTIES_FILE = "forum.properties";
	public static final String DEFAULT_SERVER_ID = "Global Pixel App";
	...
	public static final String DEFAULT_FORUM_FS_DIR = "global-pixel";
	public static final Path DEFAULT_CONTAINERS_DIR = Paths.get("containers");
	public static final RepoNames DEFAULT_FORUM_REPO_NAMES = RepoNames.ofDefault("global-pixel");

	@Inject
	AsyncHttpServer server;

	public static void main(String[] args) throws Exception {
		new GlobalPixelApp().launch(args);
	}

	@Provides
	Config config() {
		return Config.create()
				.with("image.upload.limit", "52")
	...
	protected Module getModule() {
		return combine(
				...
				new GlobalPixelModule(DEFAULT_FORUM_FS_DIR, DEFAULT_FORUM_REPO_NAMES),
				new ContainerModule<GlobalPixelContainer>() {}
