...
public final class GlobalForumApp extends Launcher {
	...
	public static final String DEFAULT_FORUM_DIR = "global-forum";
	public static final String DEFAULT_FORUM_REPO = "global-forum";
	public static final String DEFAULT_POSTS_REPO_PREFIX = "global-forum/posts";
	...
	protected Module getModule() {
		return combine(
				...
				new GlobalForumModule(
						DEFAULT_FORUM_DIR,
						DEFAULT_FORUM_REPO,
						DEFAULT_POSTS_REPO_PREFIX
				),
