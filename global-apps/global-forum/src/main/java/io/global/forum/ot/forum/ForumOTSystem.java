...
public final class ForumOTSystem {
	...
	public static OTSystem<ForumOTOperation> create(Comparator<ThreadMetadata> comparator) {
		return MergedOTSystem.mergeOtSystems(ForumOTOperation::new,
				...
				ForumOTOperation::getMetadataOps, MapOTSystem.createOTSystem(comparator));
	}
}
