...
public final class ForumUserContainer implements UserContainer {
	...
	private ForumUserContainer(Eventloop eventloop, OTDriver otDriver, FsClient fsClient, KeyPair keys, CommRepoNames names) {
		this.eventloop = eventloop;
		this.keys = keys;

		this.comm = CommGlobalState.create(eventloop, keys.getPrivKey(), otDriver, fsClient, names);
	...
	public static ForumUserContainer create(Eventloop eventloop, PrivKey privKey, OTDriver otDriver, FsClient fsClient, CommRepoNames names) {
