...
import ListItemAvatar from "@material-ui/core/ListItemAvatar";
import Avatar from "@material-ui/core/Avatar";
import RenameDocumentForm from "../../../DialogsForms/RenameDocumentForm";
import DeleteDocumentForm from "../../../DialogsForms/DeleteDocumentForm";
  ...
  render() {
    ...
    return (
      <>
        ...
        >
          <Link
            to={this.props.getDocumentPath(documentId)}
