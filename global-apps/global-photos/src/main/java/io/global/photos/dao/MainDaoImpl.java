...
public class MainDaoImpl implements MainDao {
	...
	private final GlobalPhotosContainer container;
	private final Map<String, Album> albumView;
	private final FsClient fsClient;

	private MainDaoImpl(OTStateManager<CommitId, AlbumOperation> mainStateManager, GlobalPhotosContainer container,
						AlbumDaoImpl.Builder albumDaoBuilder, Map<String, Album> albumView, FsClient fsClient) {
	...
	public static MainDaoImpl create(GlobalPhotosContainer container, AlbumDaoImpl.Builder albumDaoBuilder, FsClient fsClient) {
		OTStateManager<CommitId, AlbumOperation> mainStateManager = container.getMainState();
		Map<String, Album> albumView = ((AlbumOtState) mainStateManager.getState()).getMap();
		return new MainDaoImpl(mainStateManager, container, albumDaoBuilder, albumView, fsClient);
	}
