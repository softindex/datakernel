...
public final class GlobalFsSetup {
	...
	public void uploadDownload() {
		...
		DiscoveryService discoveryService = HttpDiscoveryService.create("http://127.0.0.1:9001/", new InetSocketAddress(0), client);
	...
	private void testDiscoveryService(AnnouncementStorage announcementStorage, RemoteFsSharedKeyStorage sharedKeyStorage) {
		...
		HttpDiscoveryService httpDiscoveryService = HttpDiscoveryService.create("http://127.0.0.1:7000", new InetSocketAddress(0), stubClient, "admin", "admin");
