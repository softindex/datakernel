...
import io.datakernel.hashfs.ClientProtocol;
...
public class GsonClientProtocol implements ClientProtocol {
	...
	@Override
	public void upload(InetSocketAddress address, String fileName,
	...
	@Override
	public void download(InetSocketAddress address, String fileName, StreamConsumer<ByteBuf> consumer, CompletionCallback callback) {
	...
	private ConnectCallback defineUpload(final InetSocketAddress address, final String fileName,
	...
	private void commit(InetSocketAddress address, final String fileName, final boolean success,
	                    final CompletionCallback callback) {
