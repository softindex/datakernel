...
public final class HashFsCommandSerialization {
	public static final Gson GSON = new GsonBuilder()
			.registerTypeAdapter(HashFsCommand.class, GsonSubclassesAdapter.builder()
					...
					.subclass("Replicas", HashFsCommandFileReplicas.class)
					.subclass("AliveServers", HashFsCommandAliveServers.class)
					.subclass("AbsentFiles", HashFsCommandAbsentFiles.class)
					.build())
			.setPrettyPrinting()
