...
public final class CrdtSynchronizer<K extends Comparable<K>, S> {
	...
	public CrdtSynchronizer(CrdtClient<K, S> local, CrdtClient<K, S> remote, LongSupplier currentRevisionSupplier) {
		this.local = local;
		this.remote = remote;
