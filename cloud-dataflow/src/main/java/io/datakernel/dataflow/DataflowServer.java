...
package io.datakernel.dataflow;
...
import io.datakernel.dataflow.command.DataflowCommandDownload;
import io.datakernel.dataflow.command.DataflowCommandExecute;
...
public final class DataflowServer extends AbstractServer<DataflowServer> {
	...
	public DataflowServer(Eventloop eventloop, ByteBufsCodec<DataflowCommand, DataflowResponse> codec, BinarySerializers serializers, ResourceLocator environment) {
		super(eventloop);
		this.codec = codec;
