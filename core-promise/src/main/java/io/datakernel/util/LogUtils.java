...
public class LogUtils {
	...
	public enum Level {
		...
		TRACE((logger, msg) -> logger.log(java.util.logging.Level.FINE, msg)) {
			@Override
			protected boolean isEnabled(Logger logger) {
		...
		DEBUG((logger, msg) -> logger.log(java.util.logging.Level.FINER, msg)) {
			@Override
			protected boolean isEnabled(Logger logger) {
		...
		WARN((logger, msg) -> logger.log(java.util.logging.Level.WARNING, msg)) {
			@Override
			protected boolean isEnabled(Logger logger) {
		...
		ERROR((logger, msg) -> logger.log(java.util.logging.Level.SEVERE, msg)) {
			@Override
			protected boolean isEnabled(Logger logger) {
	...
	public static <T> Callback<T> toLogger(Logger logger, String methodName, Object... parameters) {
		return toLogger(logger, Level.TRACE, Level.INFO, methodName, parameters);
	}
