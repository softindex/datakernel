...
public class JmxMBeansAttributesHidingTest {
	...
	public void omitsNullPojoAttributesInSingleton() {
		...
		DynamicMBean mbean = JmxMBeans.factory().createFor(singletonList(singletonWithNullPojo), defaultSettings(), false);
	...
	public void omitsPojoAttributesInWorkersIfAllWorkersReturnNull() {
		...
		DynamicMBean mbean = JmxMBeans.factory().createFor(workersWithNullPojo, defaultSettings(), false);
	...
	public void omitsNullJmxStatsAttributesInSingleton() {
		...
		DynamicMBean mbean = JmxMBeans.factory().createFor(singletonList(singletonWithNullJmxStats), defaultSettings(), false);
