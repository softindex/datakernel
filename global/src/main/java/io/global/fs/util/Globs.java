...
/**
 * Almost this whole class is stolen from {@link sun.nio.fs.Globs} util.
 */
public final class Globs {
	...
	public static PathMatcher getGlobPathMatcher(String glob) {
		Predicate<String> pred = getGlobStringPredicate(glob);
		return path -> pred.test(path.toString());
	}

	public static Predicate<String> getGlobStringPredicate(String glob) {
		String os = System.getProperty("os.name").toLowerCase(Locale.ENGLISH);
		Pattern pattern = Pattern.compile(toRegexPattern(glob, os.contains("win") && !os.contains("darwin")));
