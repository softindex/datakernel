...
public class StreamSerializerTest {
	...
	public void test1() throws Exception {
		...
		Assert.assertEquals(10, result.get(0).limit());
		Assert.assertEquals(5, result.get(1).limit());
		Assert.assertEquals(1, result.get(0).array()[4]);
		Assert.assertEquals(2, result.get(0).array()[9]);
		Assert.assertEquals(3, result.get(1).array()[4]);
	}
