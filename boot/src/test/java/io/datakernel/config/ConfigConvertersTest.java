...
public class ConfigConvertersTest {
	...
	public void testBooleanConverter() {
		...
		ConfigNode config1 = ConfigNode.defaultInstance();
		config1.set(inputString1);
		ConfigNode config2 = ConfigNode.defaultInstance();
	...
	public void testIntegerConverter() {
		...
		assertEquals(1, (int) integerConverter.get((ConfigNode) root.getChild("key1")));
		assertEquals(-5, (int) integerConverter.get((ConfigNode) root.getChild("key2")));
		assertEquals(100, (int) integerConverter.get((ConfigNode) root.getChild("key3")));
	}
	...
	public void testLongConverter() {
		...
		assertEquals(1L, (long) longConverter.get((ConfigNode) root.getChild("key1")));
		assertEquals(-5L, (long) longConverter.get((ConfigNode) root.getChild("key2")));
		assertEquals(100L, (long) longConverter.get((ConfigNode) root.getChild("key3")));
	}
	...
	public void testEnumConverter() {
		...
		assertEquals(Color.RED, enumConverter.get((ConfigNode) root.getChild("key1")));
		assertEquals(Color.GREEN, enumConverter.get((ConfigNode) root.getChild("key2")));
		assertEquals(Color.BLUE, enumConverter.get((ConfigNode) root.getChild("key3")));
	}
	...
	public void testStringConverter() {
		...
		assertEquals(inputString1, stringConverter.get((ConfigNode) root.getChild("key1")));
		assertEquals(inputString2, stringConverter.get((ConfigNode) root.getChild("key2")));
		assertEquals(inputString3, stringConverter.get((ConfigNode) root.getChild("key3")));
	}
	...
	public void testDoubleConverter() {
		...
		assertEquals(0.001, doubleConverter.get((ConfigNode) root.getChild("key1")), acceptableError);
		assertEquals(1e5, doubleConverter.get((ConfigNode) root.getChild("key2")), acceptableError);
		assertEquals(-23.1, doubleConverter.get((ConfigNode) root.getChild("key3")), acceptableError);
	}
	...
	public void testInetAddressConverter() throws UnknownHostException {
		...
		assertEquals(address1, inetSocketAddressConverter.get((ConfigNode) root.getChild("key1")));
		assertEquals(address2, inetSocketAddressConverter.get((ConfigNode) root.getChild("key2")));
		assertEquals(address3, inetSocketAddressConverter.get((ConfigNode) root.getChild("key3")));
	}
	...
	public void testListConverter() {
		...
		assertEquals(asList(1, 5, 10), listConverter.get((ConfigNode) root.getChild("key1")));
	}
}
